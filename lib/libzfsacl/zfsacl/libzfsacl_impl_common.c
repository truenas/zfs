 ...
 */
static boolean_t acl_may_inherit(zfsacl_t parent, zfsacl_t target)
{
...
zfsacl_t zfsacl_calculate_inherited_acl(zfsacl_t parent,
    zfsacl_t target, boolean_t is_dir)
{
	zfsacl_t out = NULL;
